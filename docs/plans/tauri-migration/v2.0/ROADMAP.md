...
v2.2 统计日历 ── 统计页三视图 + 记账日历视图                            ✅ 已交付
    ↓
v2.3 池机制 ──── 到期逐日生成 + 认领标记 + 日历选日期范围               ✅ 已交付
    ↓
v2.4 钱包目标 ── 多账户 + 存钱目标                                      ← 当前（TASK-040）
    ↓
...
| TASK-039 | 池机制（均摊/存池 + 认领） | v2.3 | Phase 4 | ✅ 完成 | [`TASK-039-pool-mechanism.md`](./TASK-039-pool-mechanism.md) |
...
| v2.3 ✅ | TASK-039 池机制（到期逐日生成 + 认领标记 + 日历选日期范围） | `docs/CHANGELOG-v2.3.md` |
...
*最后更新：2026-09-04 · v2.3 池机制交付，TASK-040 进入开发*
